      ...
      <div class="contact-container">
          <div class="contact-info">
            ...
            <div class="contact-download">   
              ${createLinkedButton('./CV/CV_ThaoNguyen_EN.pdf', contact[0].download[0], 'filled', 'downloadUF', 'btn-en')}
              ${createLinkedButton('./CV/CV_ThaoNguyen_FR.pdf', contact[0].download[1], 'filled', 'downloadF', 'btn-fr')}      
            </div>
