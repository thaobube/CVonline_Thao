export const portfolioAll = [
  ...
  },
  {
    ...
    description: 'This is a single web application using pure Javascript, HTML injection and Bootstraap. The project displays a collection of movies from 1968 to 2019 that every hacker & cyberpunk must watch. The user can get the info of each movie by clicking on a movie card as well as filtering the recent movies from 2000, filtering by genres or sorting by notes. There is a proposed list of 10 random movies for user in the form of carousel. The user can like the movie by clicking to the heart icon and the proposed list of movies will be changed and adapted based on the genre of user\'s liked movies.<br /><br />The web app is responsive for every devices. You can view the live version of the web app, find the code source of the project on my Github or watch the video below to see some main functions of the Web App.<br /><br /><em>Done by November, 2020</em>',
    video: '#',
  ...
  },
  {
    ...
    description: 'This is my project done for the JavaScript exam at Interface3 for less than 7 hours. This is a single web application that implements html injection from javascript and event delegation. Users can filter the validated vaccines, sort vaccines by price and add vaccines to cart then confirm/ cancel or continue to order.<br /><br />You can view the live version of the web app,find the code source of the project on my Github or watch the video below to see some main functions of the Web App.<br /><br /><em>Done by December, 2020</em>',
    video: 'Video tong hop.mp4',
  ...
  },
  {
    ...
    description: 'This is my integrated project at Interface3, using Vanilla Javascript, HTML injection and SASS (without any library or framework). The website give an introduction about myself and showcase my works. You can find the code source of the project on my Github or watch the video below to see some main functions of the Website.<br /><br /><em>Done by February, 2021</em>',
    video: 'Video tong hop.mp4',
    appLink: '#',
  ...
  },
  {
    ...
    description: 'This is our group project developed within the framework of Interface3 Hackathon in November 2020 (group of 5 students: 2 from Game Developer Class, 2 from Web Application Developer Class and 1 from Web Master Class). <br /><br /><em>Done by November, 2020.</em>',
    video: 'Robotarm.mp4',
    appLink: '#',
  ...
  },
  {
    ...
    description: 'This is my very first code exercise with HTML5/CSS - 1 month after starting the WAD program at Interface3. The exercise was based on the HTML5/CSS exam of the previous course. This website has not been responsive yet. You can find the code source of the project on my Github or watch the video below to see some main characteristics of the Website.<br /><br /><em>Done by June, 2020</em>',
    video: 'Video tong hop.mp4',
    appLink: '#',
  ...
  },
  {
    ...
    description: 'This is my very first exam with HTML5/CSS - 1 month after starting the WAD program at Interface3. The project was done by HTML5/CSS in less than 3 hours. This website has not been responsive yet. You can find the code source of the project on my Github or watch the video below to see some main characteristics of the Website.<br /><br /><em>Done by June, 2020</em>',
    video: 'Video tong hop.mp4',
    appLink: '#',
